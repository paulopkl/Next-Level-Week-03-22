    ...
    return (
        <>
            ...
            <form className="my-4 w-full" onSubmit={handleSubmitFeedback}>
                <textarea
                    className={`
                        min-w-[304px] w-full min-h-[112px] text-sm placeholder-zinc-400 text-zinc-100 border-zinc-600 
                ...
                <footer className="flex gap-2 mt-2">
                    ...
                    <button
                        type="submit"
                        className={`
                            flex flex-1 p-2 bg-brand-500 rounded-md border-transparent justify-center items-center text-sm 
